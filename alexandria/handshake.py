...
from alexandria.abc import HandshakeParticipantAPI
from alexandria.constants import HKDF_INFO, AES128_KEY_SIZE
from alexandria.tags import compute_tag
from alexandria.typing import NodeID, Tag, IDNonce, Nonce
...
class HandshakeInitiator(BaseHandshakeParticipant):
    ...
    def complete_handshake(self, response_packet: Packet) -> HandshakeResult:
        ...
        ephemeral_private_key = keys.PrivateKey(secrets.token_bytes(KEY_BYTE_SIZE))
